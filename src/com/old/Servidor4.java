...
//		}
	...
	private static boolean isValidCPFmeu(String cpf) {
		...
		//System.out.println(cpf.substring(1)+(11-resto));
		
		//System.out.println(cpf.substring(1));
		//System.out.println(cpf.substring(1,9)+(11-resto));
		
		Integer soma2 = calcularDigitoMeu(cpf.substring(1,9)+(11-resto));
		Integer resto2 = (soma2 % 11);
		System.out.println(11-resto2);
		
		//System.out.println(cpf.substring(0,9));
		
//		int soma3 = calcularDigitoMeu(cpf.substring(0,9));
//		int resto3 = (soma2 % 11);
//		System.out.println(11-resto3);
		
		//Integer ret = 11-resto;
		
		String valida = resto2.toString() + resto.toString() ;
		
		System.out.println(valida);
		System.out.println(cpf.substring(9,11));
		
		System.out.println(valida.equals(cpf.substring(9,11)));
	...
	private static int calcularDigitoMeu2(String cpf) {
